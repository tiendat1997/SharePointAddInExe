namespace SharePointAddInAssignment.Entities
{
    ...
    public partial class AdventureWorkEntity : DbContext
    {
        public AdventureWorkEntity()
            : base("name=AdventureWorkEntity")
        {
        }
        ...
        public virtual DbSet<CopyTable> CopyTables { get; set; }
